...
banner() {
	...
	clear
	printf "\n\e[1;35;47m                  \e[0m"
printf "\n\e[1;35;47m SLOPPY  \e[0m"
printf "\n\e[1;35;47m SLOPPY  \e[0m"
printf "\n\e[1;35;47m                  \e[0m"
printf "\n\n\e[3;34;40m SLOPPY - xavfsiz, kuchli va чёткий USERBOT\e[0m\n\n"
...
${SUDO_CMD}rm -rf SLOPPY
# shellcheck disable=SC2086
runout ${SUDO_CMD}git clone https://github.com/SLOPPYuz/SLOPPY|| {
...
endspin "- Tayyor! SLOPPY Sozlandi."
